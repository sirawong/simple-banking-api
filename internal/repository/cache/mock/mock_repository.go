...
func (_mock *MockRepository) Delete(ctx context.Context, key string) error {
...
func (_c *MockRepository_Delete_Call) RunAndReturn(run func(ctx context.Context, key string) error) *MockRepository_Delete_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockRepository) Set(ctx context.Context, key string, value string, ttl time.Duration) error {
...
//   - value string
//   - ttl time.Duration
func (_e *MockRepository_Expecter) Set(ctx interface{}, key interface{}, value interface{}, ttl interface{}) *MockRepository_Set_Call {
	return &MockRepository_Set_Call{Call: _e.mock.On("Set", ctx, key, value, ttl)}
}

func (_c *MockRepository_Set_Call) Run(run func(ctx context.Context, key string, value string, ttl time.Duration)) *MockRepository_Set_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockRepository_Set_Call) RunAndReturn(run func(ctx context.Context, key string, value string, ttl time.Duration) error) *MockRepository_Set_Call {
	_c.Call.Return(run)
	return _c
}
